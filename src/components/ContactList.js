          ...
          <div key={index}>
            <div className={styles.NumberItem}>
              <div className={styles.container}>
                <Link to={`/contacts/${number.name}`} className="header"><h4>{number.name}</h4></Link>
                <p>{number.phone_number}</p>
                <div className="right floated content">
                  <Link to={`/contacts/edit/${number.name}`} className="ui button primary">
                    Edit
                  </Link>
                  <Link to={`/contacts/delete/${number.name}`} className="ui button negative">
                    Delete
                  </Link>
                </div>
              </div>
